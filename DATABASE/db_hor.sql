...
INSERT INTO `managers` (`managers_id`, `name`, `username`, `email`,`password`) VALUES
(1, 'Managers', 'managers', 'manager');
...
--
ALTER TABLE `managers`
  MODIFY `managers_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
